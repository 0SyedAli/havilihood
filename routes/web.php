...
use App\Livewire\Front\Auth\Recruiter\Otp;
...
Route::get('/candidate-otp', \App\Livewire\Front\Auth\Candidate\Otp::class)->name('candidate.otp');
...
Route::get('/company-info', \App\Livewire\Front\Auth\Recruiter\CompanyInfo::class)->name('company.info');
