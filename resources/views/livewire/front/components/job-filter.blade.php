<div>
    <div class="filter_top d-flex gap-5 alig-items-center">
        <button class="filter_btn" data-bs-target="#jobFilter" data-bs-toggle="modal">Filter <span>+</span></button>
    ...
    <div class="contact-modal">
        <!-- Modal start -->
        <div class="modal fade" id="jobFilter" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div class="form-input">
                                        ...
                                        <div class="d-flex align-items-center  pt-4 flex-wrap gap-3 gap-sm-0">
                                            ...
                                            <div class="w25 px-0 d-flex align-items-center gap-2">
                                                <div class="custom-checkbox">
                                                    <input class="form-check-input" type="checkbox" wire:model="job_type" value="Freelance" id="Freelance">
                                                    <div class="checkmark"></div>
                                                </div>
                                            ...
                                            <div class="w25 px-0 d-flex align-items-center gap-2">
                                                <div class="custom-checkbox">
                                                    <input class="form-check-input" type="checkbox" wire:model="job_type" value="Temporary" id="Temporary">
                                                    <div class="checkmark"></div>
                                                </div>
                                    ...
                                    <div class="form-input">
                                        <h4 for="">Pay Period</h4>
                                        <div class="d-flex align-items-center  pt-4 flex-wrap gap-3 gap-sm-0">
                                            <div class="w25 px-0 d-flex align-items-center gap-2">
                                                <div class="custom-checkbox">
                                                    <input class="form-check-input" type="checkbox" value="per hour" wire:model="pay_period" id="pay_period1">
                                                    <div class="checkmark"></div>
                                                </div>
                                                <label class="form-check-label" for="pay_period1">
                                                    per hour
                                                </label>
                                            </div>
                                            <div class="w25 px-0 d-flex align-items-center gap-2">
                                                <div class="custom-checkbox">
                                                    <input class="form-check-input" type="checkbox" value="per week" wire:model="pay_period" id="pay_period2">
                                                    <div class="checkmark"></div>
                                                </div>
                                                <label class="form-check-label" for="pay_period2">
                                                    per week
                                                </label>
                                            </div>
                                            <div class="w25 px-0 d-flex align-items-center gap-2">
                                                <div class="custom-checkbox">
                                                    <input class="form-check-input" type="checkbox" value="per month" wire:model="pay_period" id="pay_period3">
                                                    <div class="checkmark"></div>
                                                </div>
                                                <label class="form-check-label" for="pay_period3">
                                                    per month
                                                </label>
                                            </div>
                                            <div class="w25 px-0 d-flex align-items-center gap-2">
                                                <div class="custom-checkbox">
                                                    <input class="form-check-input" type="checkbox" value="per year" wire:model="pay_period" id="pay_period3">
                                                    <div class="checkmark"></div>
                                                </div>
                                                <label class="form-check-label" for="pay_period3">
                                                    per year
